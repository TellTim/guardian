...
// 作者姓名 修改时间 版本号 描述
//
package com.telltim.xtask.factory
 ...
 */
internal class XThreadFactory(private val threadName: String,private val priority:Int = Process
    .THREAD_PRIORITY_DEFAULT) :ThreadFactory {
