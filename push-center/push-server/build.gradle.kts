    ...
    defaultConfig {
        ...
        addManifestPlaceholders(
            mapOf(
                ...
                "JPUSH_APPKEY" to "xxxxx",
                "JPUSH_CHANNEL" to "xxxxxzzzzzzzzzzzzzz",
                "ACCESS_TOKEN" to "xxxxxyyyyyyyyyy"
            )
        )
...
dependencies {
    ...
    // 引入极光 SDK
    implementation(ThirdDeps.JPushDeps.jpush)
    implementation(ThirdDeps.JPushDeps.jcore)
}